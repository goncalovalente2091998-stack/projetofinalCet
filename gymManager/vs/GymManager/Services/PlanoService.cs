...
namespace GymManager.Services
{
    public class PlanoService
    {
        ...
        public List<Plano> Listar()
        {
            ...
            using SqlCommand cmd = new SqlCommand("sp_Planos_Listar", conn);
        ...
        public void Inserir(Plano plano)
        {
            ...
            using SqlCommand cmd = new SqlCommand("sp_Planos_Inserir", conn);
            ...
            cmd.Parameters.AddWithValue("@Descricao", string.IsNullOrWhiteSpace(plano.Descricao) ? DBNull.Value : plano.Descricao);
        ...
        public void Atualizar(Plano plano)
        {
            ...
            using SqlCommand cmd = new SqlCommand("sp_Planos_Atualizar", conn);
        ...
        public void Eliminar(int idPlano)
        {
            ...
            using SqlCommand cmd = new SqlCommand("sp_Planos_Eliminar", conn);
        ...
        public List<Plano> Pesquisar(string pesquisa)
        {
            ...
            using SqlCommand cmd = new SqlCommand("sp_Planos_Pesquisar", conn);
