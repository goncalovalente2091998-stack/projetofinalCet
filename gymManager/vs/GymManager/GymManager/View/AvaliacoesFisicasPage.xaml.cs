...
namespace GymManager.View
{
    ...
    {
        private readonly AvaliacaoFisicaService service =
        ...
        private void CarregarAvaliacoes()
        {
            ...
            {
                Mensagem.Erro(
                    "Não foi possível carregar as avaliações físicas.\n\n" +
                    ex.Message);
            }
        }
        ...
        private void btnNovo_Click(
            ...
            RoutedEventArgs e)
        {
            AvaliacaoFisicaForm form =
                new AvaliacaoFisicaForm
                {
        ...
        private void btnEditar_Click(
            ...
            RoutedEventArgs e)
        {
            if (dgAvaliacoes.SelectedItem is not
                AvaliacaoFisica avaliacao)
            {
                Mensagem.Aviso(
                    "Selecione uma avaliação física.");

                return;
            }

            AvaliacaoFisicaForm form =
                new AvaliacaoFisicaForm(avaliacao)
                {
                    Owner = Window.GetWindow(this)
                };
        ...
        AvaliacaoFisica avaliacao)
            ...
            if (!Mensagem.Confirmar(
                    $"Tem a certeza que pretende eliminar a avaliação " +
            ...
            try
            {
                ...
                Mensagem.Sucesso(
                    "Avaliação física eliminada com sucesso!");
            ...
            {
                Mensagem.Erro(
                    "Não foi possível eliminar a avaliação física.\n\n" +
                    ex.Message);
            }
        }
            ...
            TextChangedEventArgs e)
        {
            ...
            {
                Mensagem.Erro(
                    "Não foi possível pesquisar as avaliações físicas.\n\n" +
                    ex.Message);
            }
        }
     ...
     RoutedEventArgs e)
        {
            ...
            dlg.FileName =
                $"Avaliacao_{avaliacao.IdAvaliacao}.pdf";
