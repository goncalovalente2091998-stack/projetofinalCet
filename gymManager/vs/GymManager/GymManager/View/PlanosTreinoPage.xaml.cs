...
namespace GymManager.View
{
    ...
    {
        private readonly PlanoTreinoService service =
        ...
        private void btnEditar_Click(
            ...
            RoutedEventArgs e)
        {
            if (dgPlanosTreino.SelectedItem is not
                PlanoTreino plano)
            {
                Mensagem.Aviso(
            ...
            RoutedEventArgs e)
        {
            ...
            if (!Mensagem.Confirmar(
                    $"Tem a certeza que pretende eliminar o plano " +
                    $"'{plano.NomePlano}' do cliente " +
                    $"'{plano.NomeCliente}'?"))
            {
                return;
            }
            ...
            {
                Mensagem.Erro(
                    "Não foi possível eliminar o plano de treino.\n\n" +
                    ex.Message);
            }
        }

        private void btnExercicios_Click(
            object sender,
            RoutedEventArgs e)
        {
            if (dgPlanosTreino.SelectedItem is not
            ...
            NavigationService?.Navigate(
                new PlanoTreinoExerciciosPage(plano));
        }
            ...
            TextChangedEventArgs e)
        {
            ...
            {
                Mensagem.Erro(
                    "Não foi possível pesquisar os planos de treino.\n\n" +
                    ex.Message);
            }
        }
      ...
      RoutedEventArgs e)
        {
            ...
            {
                PdfPlanoTreino.Gerar(
                    dlg.FileName,
                    plano);

                Mensagem.Sucesso(
                    "Plano exportado com sucesso.");
            }
        }
    }
}