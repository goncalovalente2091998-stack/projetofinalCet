...
namespace GymManager.View
{
    public partial class EquipamentosPage : Page
    {
        ...
        private void btnEditar_Click(
            ...
            RoutedEventArgs e)
        {
            if (dgEquipamentos.SelectedItem is not
            ...
            EquipamentoForm form =
                new EquipamentoForm(equipamento)
                {
                    Owner = Window.GetWindow(this)
                };
            ...
            RoutedEventArgs e)
        {
            ...
            {
                Mensagem.Aviso(
                    "Um equipamento em manutenção não pode ser eliminado.");
            ...
            {
                Mensagem.Aviso(
                    "Um equipamento abatido não pode ser eliminado.");
            ...
            {
                Mensagem.Erro(
                    "Não foi possível eliminar o equipamento.\n\n" +
                    ex.Message);
            }
        }
