    ...
    namespace GymManager.Services
    {
        public class PlanoTreinoService
        {
            ...
            public List<PlanoTreino> Listar()
            {
                ...
                {
                    lista.Add(
                        MapearPlanoTreino(reader));
                }

                return lista;
            }

            public PlanoTreino? ObterPorId(
                int idPlanoTreino)
            {
                using SqlConnection conn =
                    db.GetConnection();
                ...
                using SqlCommand cmd =
                    new SqlCommand(
                        "dbo.sp_PlanosTreino_ObterPorId",
                        conn);
            ...
            public List<PlanoTreino> Pesquisar(
                string pesquisa)
            {
                List<PlanoTreino> lista =
                    new List<PlanoTreino>();
            ...
            private static PlanoTreino MapearPlanoTreino(
