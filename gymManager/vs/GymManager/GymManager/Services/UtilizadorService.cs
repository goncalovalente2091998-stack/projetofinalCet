    ...
    public class UtilizadorService
    {
        ...
        public Utilizador? ObterPorEmail(string email)
        {
            ...
            using SqlCommand cmd =
                new SqlCommand("sp_Utilizadores_ObterPorEmail", conn);
        ...
        public List<Utilizador> Listar()
        {
            ...
            using SqlCommand cmd =
                new SqlCommand("sp_Utilizadores_Listar", conn);
        ...
        public void Inserir(Utilizador utilizador)
        {
            ...
            using SqlCommand cmd =
                new SqlCommand("sp_Utilizadores_Inserir", conn);
        ...
        public void Atualizar(Utilizador utilizador)
        {
            ...
            using SqlCommand cmd =
                new SqlCommand("sp_Utilizadores_Atualizar", conn);
        ...
        public void Eliminar(int idUtilizador)
        {
            ...
            using SqlCommand cmd =
                new SqlCommand("sp_Utilizadores_Eliminar", conn);
        ...
        public Utilizador? ObterPorId(int idUtilizador)
        {
            ...
            using SqlCommand cmd =
                new SqlCommand("sp_Utilizadores_ObterPorId", conn);
            ...
            {
                IdUtilizador =
                    Convert.ToInt32(reader["IdUtilizador"]),
                ...
                Perfil =
                    reader["Perfil"].ToString() ?? string.Empty
            };
        }
        ...
        public List<Utilizador> Pesquisar(string pesquisa)
        {
            ...
            using SqlCommand cmd =
                new SqlCommand("sp_Utilizadores_Pesquisar", conn);
