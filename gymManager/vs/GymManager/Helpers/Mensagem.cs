...
namespace GymManager.Helpers
{
    public static class Mensagem
    {
        ...
        {
            return MessageBox.Show(texto,"Confirmação",MessageBoxButton.YesNo,MessageBoxImage.Question) == MessageBoxResult.Yes;
        }

        public static void Sucesso(string texto)
        {
            MessageBox.Show(texto,"Sucesso",MessageBoxButton.OK,MessageBoxImage.Information);
        }
        ...
        {
            MessageBox.Show(texto,"Aviso",MessageBoxButton.OK,MessageBoxImage.Warning);
        }
